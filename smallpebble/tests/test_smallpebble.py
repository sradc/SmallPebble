...
def test_operation_and_placeholder_result():
    ...
    a = sp.Placeholder()
    b = sp.Placeholder()
    c = sp.LazyOp(sp.matmul)(a, b)
    d = sp.LazyOp(sp.mul)(c, sp.Variable(np.array(5)))
...
def test_learnable_and_get_learnables():
    ...
    b = sp.Placeholder()
    y = sp.LazyOp(sp.matmul)(a, b)
    y = sp.LazyOp(sp.mul)(y, param_1)
    y = sp.LazyOp(sp.add)(y, param_2)
